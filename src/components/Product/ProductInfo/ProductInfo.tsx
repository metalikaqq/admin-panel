...
function ProductInfo({ onUpdate }: ProductInfoProps) {
  ...
  const addInput = (type: InputType) => {
    const newInput: InputField = {
      ...
      items:
        type === 'list'
          ? [{ id: Date.now().toString(), content: { uk: '', en: '' }, sublist: [] }]
          : undefined,
    };
    setInputs([...inputs, newInput]);
  };
  ...
  const updateListItem = (inputId: string, itemId: string, language: Language, value: string) => {
    setInputs(
      inputs.map((input) => {
        if (input.id === inputId && input.items) {
          const updatedItems = input.items.map((item) => {
      ...
      <AnimatePresence>
        {inputs.map((input, index) => (
          ...
          >
            ...
            <div className={s.inputContent}>
              <p className={s.product__name__title}>
                {input.label}
              </p>
                    ...
                    <div key={item.id} className={s.listItem}>
                      ...
                      <div className={s.languageField}>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateListItem(input.id, item.id, 'uk', e.target.value)
                          }
                      ...
                      <div className={s.languageField}>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateListItem(input.id, item.id, 'en', e.target.value)
                          }
                ...
                <div className={s.languageFields}>
                  ...
                  <div className={s.languageField}>
                    ...
                    <input
                      ...
                      onChange={(e) => updateInputValue(input.id, 'uk', e.target.value)}
                  ...
                  <div className={s.languageField}>
                    ...
                    <input
                      ...
                      onChange={(e) => updateInputValue(input.id, 'en', e.target.value)}
